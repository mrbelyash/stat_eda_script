...
df15 <- read.csv("C:/Users/daniil/Downloads/2015.csv")
df16 <- read.csv("C:/Users/daniil/Downloads/2016.csv")
...
# Testing North/South difference with 2-sample t-test
...
t_res <- t.test(north15, south15, var.equal = TRUE)
